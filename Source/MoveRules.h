...
public:
  ...
  /**
  * MoveRules is the default constructor for the MoveRules class.
  ...
  */
  ...
  /**
  * ~MoveRules is the default destructor for objects of type MoveRules.
  */
  virtual ~MoveRules();

  /**
  * getMovementRules is the function that provides rules regarding direction and magnitude per Piece
